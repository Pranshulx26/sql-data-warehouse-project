...
It consists of well-structured **dimension tables** and **fact tables** that store specific business metrics in a user-friendly format.
...
| sales_amount    | INT            | The total monetary value of the sale for the line item (e.g., 25). |
